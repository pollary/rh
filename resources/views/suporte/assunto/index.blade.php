  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title w-100 text-center">Número do chamado</h5>
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group text-center">
            <button type="button" class="btn btn-success bg-teal" id="sucesso-btn">Success</button>
          </div>
        </form>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  sucessoBtn.addEventListener('click', function(event){
    ...
    var url = "{{ route('chamados.show', ['id' => ":id"]) }}";
    url = url.replace("%3Aid", id); //Trocando o html ':id' pelo valor real do id
    console.log(url); 
